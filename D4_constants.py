from chemistry_constants import angstrom_to_bohr_conversion_constant
...
covalent_radii = [angstrom_to_bohr_conversion_constant*r*(4./3.) for r in covalent_rad_2009]
