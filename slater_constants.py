from GFN2_constants import max_number_of_subshells, max_element, angular_momentum_of_subshell, principal_quantum_number
pAlpha1 = [
    [[2.709498091e-1],# 1s
    [1.012151084e-1],# 2s
    [5.296881757e-2],# 3s
...
pAlpha4 = [
    [[5.216844534e+0, 9.546182760e-1,
    2.652034102e-1, 8.801862774e-2],# 1s
    [1.161525551e+1, 2.000243111e+0,
    1.607280687e-1, 6.125744532e-2],# 2s
    [1.513265591e+0, 4.262497508e-1,
    7.643320863e-2, 3.760545063e-2],# 3s
    [3.242212833e-1, 1.663217177e-1,
    5.081097451e-2, 2.829066600e-2],# 4s
    [8.602284252e-1, 1.189050200e-1,
    3.446076176e-2, 1.974798796e-2]],# 5s
    [[1.798260992e+0, 4.662622228e-1,
    1.643718620e-1, 6.543927065e-2],# 2p
    [1.853180239e+0, 1.915075719e-1,
    8.655487938e-2, 4.184253862e-2],# 3p
    [1.492607880e+0, 4.327619272e-1,
    7.553156064e-2, 3.706272183e-2],# 4p
    [3.962838833e-1, 1.838858552e-1,
    4.943555157e-2, 2.750222273e-2]],# 5p
    [[9.185846715e-1, 2.920461109e-1,
    1.187568890e-1, 5.286755896e-2],# 3d
    [1.995825422e+0, 1.823461280e-1,
    8.197240896e-2, 4.000634951e-2],# 4d
    [4.230617826e-1, 8.293863702e-2,
    4.590326388e-2, 2.628744797e-2]],# 5d
    [[5.691670217e-1, 2.074585819e-1,
    9.298346885e-2, 4.473508853e-2],# 4f
    [2.017831152e-1, 1.001952178e-1,
    5.447006630e-2, 3.037569283e-2]],# 5f
    [[3.945205573e-1, 1.588100623e-1,
    7.646521729e-2, 3.898703611e-2]] # 5g
]

pCoeff4 = [
    [[ 5.675242080e-2, 2.601413550e-1,
     5.328461143e-1, 2.916254405e-1],# 1s
    [-1.198411747e-2,-5.472052539e-2,
     5.805587176e-1, 4.770079976e-1],# 2s
    [-3.295496352e-2,-1.724516959e-1,
     7.518511194e-1, 3.589627317e-1],# 3s
    [-1.120682822e-1,-2.845426863e-1,
     8.909873788e-1, 3.517811205e-1],# 4s
    [ 1.103657561e-2,-5.606519023e-1,
     1.179429987e+0, 1.734974376e-1]],# 5s
    [[ 5.713170255e-2, 2.857455515e-1,
     5.517873105e-1, 2.632314924e-1],# 2p
    [-1.434249391e-2, 2.755177589e-1,
     5.846750879e-1, 2.144986514e-1],# 3p
    [-6.035216774e-3,-6.013310874e-2,
     6.451518200e-1, 4.117923820e-1],# 4p
    [-1.801459207e-2,-1.360777372e-1,
     7.533973719e-1, 3.409304859e-1]],# 5p
    [[ 5.799057705e-2, 3.045581349e-1,
     5.601358038e-1, 2.432423313e-1],# 3d
    [-2.816702620e-3, 2.177095871e-1,
     6.058047348e-1, 2.717811257e-1],# 4d
    [-2.421626009e-2, 3.937644956e-1,
     5.489520286e-1, 1.190436963e-1]],# 5d
    [[ 5.902730589e-2, 3.191828952e-1,
     5.639423893e-1, 2.284796537e-1],# 4f
    [ 9.174268830e-2, 4.023496947e-1,
     4.937432100e-1, 1.254001522e-1]],# 5f
    [[ 6.010484250e-2, 3.309738329e-1,
     5.655207585e-1, 2.171122608e-1]] # 5g
]
pAlpha5 = [
    [[1.130563696e+1, 2.071728178e+0, 5.786484833e-1,
    1.975724573e-1, 7.445271746e-2],                # 1s
    [8.984956862e+0, 1.673710636e+0, 1.944726668e-1,
    8.806345634e-2, 4.249068522e-2],                # 2s
    [4.275877914e+0, 1.132409433e+0, 4.016256968e-1,
    7.732370620e-2, 3.800708627e-2],                # 3s
    [2.980263783e+0, 3.792228833e-1, 1.789717224e-1,
    5.002110360e-2, 2.789361681e-2],                # 4s
    [7.403763257e-1, 1.367990863e-1, 9.135301779e-2,
    3.726907315e-2, 2.241490836e-2]],                # 5s
    [[3.320386533e+0, 8.643257633e-1, 3.079819284e-1,
    1.273309895e-1, 5.606243164e-2],                # 2p
    [6.466803859e+0, 1.555914802e+0, 1.955925255e-1,
    8.809647701e-2, 4.234835707e-2],                # 3p
    [1.091977298e+0, 3.719985051e-1, 8.590019352e-2,
    4.786503860e-2, 2.730479990e-2],                # 4p
    [3.422168934e-1, 1.665099900e-1, 5.443732013e-2,
    3.367775277e-2, 2.091949042e-2]],                # 5p
    [[1.539033958e+0, 4.922090297e-1, 2.029756928e-1,
    9.424112917e-2, 4.569058269e-2],                # 3d
    [1.522122079e+0, 2.173041823e-1, 1.084876577e-1,
    5.836797641e-2, 3.206682246e-2],                # 4d
    [9.702946470e-1, 3.603270196e-1, 8.668717752e-2,
    4.833708379e-2, 2.751899341e-2]],                # 5d
    [[8.925960415e-1, 3.277589120e-1, 1.492869962e-1,
    7.506099109e-2, 3.892475795e-2],                # 4f
    [1.670735676e+0, 2.072477219e-1, 1.024709357e-1,
    5.537913898e-2, 3.072866652e-2]],                # 5f
    [[5.895429375e-1, 2.393343780e-1, 1.172646904e-1,
    6.254074479e-2, 3.411243214e-2]] # 5g
]
...
pCoeff6 = [
      [[ 4.554359511e-3, 5.286443143e-2,-7.561016358e-1,  # 1s
        2.269803820e-1, 1.332494651e+0, 3.622518293e-1], 
      [ 4.554359511e-3, 5.286443143e-2,-7.561016358e-1,  # 2s
       2.269803820e-1, 1.332494651e+0, 3.622518293e-1], 
      [ 4.554359511e-3, 5.286443143e-2,-7.561016358e-1,  # 3s
       2.269803820e-1, 1.332494651e+0, 3.622518293e-1], 
     #[ 1.374817488e-3,-8.666390043e-2,-3.130627309e-1,  # 4s
     # 7.812787397e-1, 4.389247988e-1, 2.487178756e-2], 
      [ 4.554359511e-3, 5.286443143e-2,-7.561016358e-1,  # 4s (old)
       2.269803820e-1, 1.332494651e+0, 3.622518293e-1],   
      [ 4.554359511e-3, 5.286443143e-2,-7.561016358e-1,  # 5s
       2.269803820e-1, 1.332494651e+0, 3.622518293e-1],
      [ 4.554359511e-3, 5.286443143e-2,-7.561016358e-1,  # 6s
       2.269803820e-1, 1.332494651e+0, 3.622518293e-1]], 
      [[ 2.782723680e-3,-1.282887780e-1,-2.266255943e-1,  # 2p
       4.682259383e-1, 6.752048848e-1, 1.091534212e-1], 
      [ 2.782723680e-3,-1.282887780e-1,-2.266255943e-1,  # 3p
       4.682259383e-1, 6.752048848e-1, 1.091534212e-1], 
     #[-1.665913575e-3,-1.657464971e-2,-5.958513378e-2,  # 4p
     # 4.053115554e-1, 5.433958189e-1, 1.204970491e-1], 
      [ 2.782723680e-3,-1.282887780e-1,-2.266255943e-1 ,  # 4p (old)
       4.682259383e-1, 6.752048848e-1, 1.091534212e-1],   
      [ 2.782723680e-3,-1.282887780e-1,-2.266255943e-1,  # 5p
       4.682259383e-1, 6.752048848e-1, 1.091534212e-1],
...
# index with [number of Gaussians][angular momentum][principal quantum number][Gaussian_idx]
gaussian_exponents = [
    [[[]]],
    pAlpha1,
    pAlpha2,
...
gaussian_contraction_coefficients = [
    [[[]]],
    pCoeff1,
    pCoeff2,
    pCoeff3,
...
# index with [atom_id][angular momentum]
slater_exponents = [ #zeta_l
...
def set_GFN2_number_of_gaussians():
    number_of_gaussians = [[0]*max_number_of_subshells]*max_element
    for atom in range(max_element):
        for subshell in range(max_number_of_subshells):
            nPrim = 0
            if atom <= 2:
                match angular_momentum_of_subshell[atom][subshell]:
                    case 0:
                        nPrim = 3
                    case 1:
                        nPrim = 4
                ...
                match angular_momentum_of_subshell[atom][subshell]:
                    case 0:
                        if principal_quantum_number[atom][subshell] > 5:
                            nPrim = 6
                        else: 
                            nPrim = 4
                    case 1:
                    ...
                    case 3:
                        nPrim = 4
            number_of_gaussians[atom][subshell] = nPrim
    return number_of_gaussians
number_of_gaussians = set_GFN2_number_of_gaussians()
#import numpy as np
